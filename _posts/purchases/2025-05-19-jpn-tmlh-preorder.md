---
title: "Purchase: Too Many Losing Heroines!(JPN) Preorders"
date: 2025-09-01
categories:
  - purchases
excerpt: "All preorders done for Too Many Losing Heroines!(JPN)"
classes: wide
---
...
// Default filter - only show this set (note: matches the exact spelling in your sheet)
const DEFAULT_SET_FILTER = 'Too Many Losing Heiroines(JPN)';
...
![Flipside Receipt]({{ site.baseurl }}/assets/images/receipts/2025/flipside-tmlh.jpg)